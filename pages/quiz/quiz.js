    ...
    main.innerHTML =
        ...
        <section class="alternativas">
            ...
            <label for="alternativa_b">
                <input type="radio" id="alternativa_b" name="alternativa" value =" ${alterarSinais(quiz.qustions[pergunta-1].options[1])}">
                <div>
                    <span>B</span>
                   ${alterarSinais(quiz.qustions[pergunta-1].options[1])}
                </div>
                </label>
...
function validarResposta() {
    ...
    botaoEnviar.addEventListener("click",próximaPergunta)
